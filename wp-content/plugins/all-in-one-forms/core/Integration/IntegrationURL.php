...
class IntegrationURL
{
    ...
    public static function PreviewURL(){
        $previewPage=get_page_by_title("All in one forms Preview","OBJECT","rednao_forms_preview");
        $page_id=0;
        if($previewPage==null)
        {
            $post = array(
                'post_content'   => '[rnformpreview]	',
                'post_name'      => 'All in one Forms Preview',
                'post_title'     => 'All in one Forms Preview',
                'post_status'    => 'draft',
