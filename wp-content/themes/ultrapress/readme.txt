...
Ultrapress WordPress Theme, Copyright 2020 Uncodethemes
Ultrapress is distributed under the terms of the GNU GPL
...
Supports Elementor PageBuilder

== Changelog ==

== 1.2.1 ==
* Fixed metabox saving issue in classic editor

== 1.2.0 ==
* Made compatiable with PHP version 8 and WordPress version 6.2

== 1.1.9 ==
* Added upsell button
* Added premium feature with disabled
* Enqueue google font from local

== 1.1.8 ==
* Fixed Elementor custom header design issue while loading page
...
== 1.1.5 ==
* fixed file missing while updating theme
...
== 1.0.7 ==
* fixed adovative height for images
* fixed pagination settings
* change the position of scroll to top settings in customizer
...
= FontAwesome =
-------------------------------------------------------
Icons used in the Screenshot image are all licensed under Creative Commons ( CC BY 4.0 ) 
License ( https://fontawesome.com/license/free )
https://fontawesome.com/v5/icons/facebook-f?s=brands
...
-------------------------------------------------------
* License: Licensed GPL-2.0 or later license.
...
-------------------------------------------------------
* License: Licensed under MIT
* https://github.com/WPTT/webfont-loader/blob/master/LICENSE
* https://github.com/WPTT/webfont-loader

-------------------------------------------------------
= Customizer Class Control License =
-------------------------------------------------------
* Custom Control Base Class, Custom Section Base Class, Image Checkbox Custom Control, Text Radio Button Custom Control, Image Radio Button Custom Control, Single Accordion Custom Control, Simple Notice Custom Control, Slider Custom Control, Toggle Switch Custom Control, Sortable Repeater Custom Control, Dropdown Posts Custom Control, TinyMCE Custom Control, Google Font Select Custom Control, WPColorPicker Alpha Color Picker Custom Control, Sortable Pill Checkbox Custom Control
* Credit Anthony Hortin
* License: Licensed under GPL-2.0
...
https://stocksnap.io/photo/inspirational-word-RWBGK0N3M1

-------------------------------------------------------
== Screenshot Licenses ==
-------------------------------------------------------
Screenshot images are all licensed under CCO Universal
Image for theme screenshot, Credit Kristin Hardwick
