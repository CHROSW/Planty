...
$wp_customize->add_setting( 'ultrapress_post_content_reorder',
	array(
		'default' => apply_filters('ultrapress_post_content_reorder_defaults','featured_image,title,meta_tag,content,social_share,coments,navigation'),
		'transport' => 'refresh',
...
$wp_customize->add_control( new Ultrapress_Pill_Checkbox_Custom_Control( $wp_customize, 'ultrapress_post_content_reorder',
	array(
		...
		'choices' => apply_filters( 'ultrapress_post_content_reorder_array', $content_reorder ),
		'priority' => 3
	)
) );
...
$wp_customize->add_control(
	new Ultrapress_Sidebar_Dropdown_Custom_Control(
		$wp_customize, 'ultrapress_post_sidebar', array(
			...
			'section'  		=> 'ultrapress_single_post_section',
			'priority' => 5,
			'active_callback'  		=> 'ultrapress_single_sidebar_cb',
		)
	)
);
// Upsell button
$wp_customize->add_setting( 'ultrapress_single_post_upsell',
	array(
		'default' => false,
		'transport' => 'refresh',
		'sanitize_callback' => 'sanitize_text_field'
...
$wp_customize->add_control( 
	new Ultrapress_Control_Description( 
		$wp_customize, 'ultrapress_single_post_upsell',
		array(
			'section' => 'ultrapress_single_post_section',
		)
	) 
