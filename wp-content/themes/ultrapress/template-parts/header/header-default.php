...
$container = get_theme_mod('ultrapress_header_container_switch', 'default');
	...
	<div class="<?php echo esc_attr($c_class); ?>">
		<nav class="navbar navbar-expand-lg">
			...
			<div class="navbar-brand">
				...
				$desc = get_theme_mod( 'ultrapress_tagline_desc', false );
				$ultrapress_description = get_bloginfo('description', 'display');
				if ( ( $ultrapress_description || is_customize_preview() ) && $desc) :
				?>
			...
			$btn_link_new = get_theme_mod('ultrapress_purchase_btn_link_open', false);
			if($btn_link_new){
